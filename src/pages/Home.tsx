...
const Home = () => {
    ...
    return (
        <div
            className="relative min-h-screen flex flex-col items-center justify-center p-5 bg-cover bg-center"
        ...
        >
            ...
            <AnimatePresence>
                {!isLoading && (
                    <motion.div
                        className="relative z-10 flex flex-col items-left w-full max-w-4xl"
                    ...
                    >
                        <h1 className="text-3xl text-white mb-6 font-bold">
                            <span className="text-5xl">Welcome</span> to <br />
                            <span className="text-yellow-400">Myt Lounge🍻</span>
                        </h1>
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="bg-blue-950/90 backdrop-blur-sm p-6 rounded-xl shadow-md cursor-pointer"
                            >
                            ...
                            {/* Events & Promotions */}
                            <motion.div className="bg-yellow-200 p-6 rounded-xl shadow-md opacity-60 cursor-not-allowed relative">
